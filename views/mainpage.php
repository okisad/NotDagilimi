        ...
        <div class="container">
            <div class="row topbuffer3">
                <div class="col-md-12 text-center">
                    ...
                    <p class="topbuffer5 text-danger">Üyeliğiniz aktive edilemediği için bu bölümü görme yetkiniz
                        yoktur.</p>
                </div>
            </div>
            <div class="row topbuffer3">
    ...
    <div class="section" data-anchor="unlock-page">
        <div class="container">
            <div class="row topbuffer5">
                <div class="unlock-page-first-section col-xs-7">
                    <h1 class="text-uppercase text-center">Burayı Okuyunuz</h1>

                    <div class="topbuffer4" id="kilitacbilgilendirme">
                        <p class="text-warning">- ITU sis bilgileriniz hiç bir şekilde kayıt altında
                            tutulmamaktadır.</p>

                        <p class="text-warning">- Amacımız İTÜ öğrencilerinin elinde bulunan not dağılımı bilgilerini
                            tek bir çatıda toplamaktır.</p>

                        <p class="text-warning">- Nasıl güvenimipte bilgilerini paylaşacağınızı düşünüyorsanız size
                            birkaç önerimiz var;</p>
                        <ul class="text-danger">
                            <li><p>Bilgileriniz paylaştıktan sonra şifrenizi değiştirebilirsiniz</p></li>
                            <li><p>Şifrem aynı kalsın diyorsanız, bilgilerinizi paylaşmadan önce şifreninizi değiştirip,
                                    paylaştıktan sonra eski şifrenize dönebilirsiniz</p></li>
                        </ul>
                        <p class="text-success">- Sis bilgilerinizi doğru girdiğiniz taktirde kilidiniz açılacaktır.</p>
                    </div>
                </div>
                <div class="col-xs-4 col-xs-offset-1" id="itu-register-screen">
                    ...
                    <form data-toggle="validator" id="itusisform" method="post" action="../mainpageback.php"
                        ...
                        <div class="form-group">
                            <input class="form-control" name="kullaniciadi" type="text" required="true"
                                   placeholder="Kullanıcı Adı">
                        </div>
                        <div class="form-group">
                            <input class="form-control" name="sifre" type="password" required="true"
                                   placeholder="Şifre">
                        </div>
                        <div class="form-group">
                            <input class="form-control" name="pin" type="password" required="true"
                                   placeholder="İTÜ SİS pin">
                        </div>
                        <div class="form-group topbuffer4">
                            <a href="mainpageunlocked.php" class="animsition-link" data-animsition-out-duration="2000">
                                <button class="btn btn-lg btn-success btn-block" type="submit" name="itusisformbutton">
                                    Gönder
                                </button>
                            </a>
                        </div>
